function [x,y,z,radii] = GetCotainedCircle(x1,y1,z1,x2,y2,z2,x3,y3,z3)
%% calcualting the internal circle bounded within a tringle
...
%% actual calculations
try
    p1 = [mean([x1,x2]),mean([y1,y2]),mean([z1,z2])];
    p2 = [mean([x3,x2]),mean([y3,y2]),mean([z3,z2])];
    p3 = [mean([x1,x3]),mean([y1,y3]),mean([z1,z3])];
...
end %function  GetCotainedCircle