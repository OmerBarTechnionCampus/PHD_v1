function [center,rad,v1n,v2nb,msgs] = circlefit3d(p1,p2,p3)
...
if (find(sum(abs(nv),2)<1e-5))
    ...
    msgs = '??? Warning using ==> cirlefit3d, Some corresponding input points are nearly collinear.';
end
